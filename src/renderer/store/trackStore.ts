...
import { isOffRoad, isAirborne, isCollisionImpulse, isHandbrake } from '@shared/analysis/frameFlags';
...
export const useTrackStore = create<TrackStoreState>((set, get) => ({
  ...
  clearPath() {
    set({ frames: [], laps: [], positionChanges: [], origin: null, _prevLap: -1, _prevRacePos: 0 });
  },
